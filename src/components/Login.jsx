...
const Login = () => {
  ...
  return (
    <div>
      <Header />
      <div className=" absolute w-screen h-screen bg-cover bg-center">
        <img
      ...
      <form
        ...
        className="w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-8   0"
      >
